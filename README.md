...
**Omer:** CSP + SVM/LDA + Hyperparameter optimization for 10 subjects, Raw + CNN (2 electrodes), Raw + RNN, STFT + CNN ( Final Selection: CSP + SVM/LDA 82% avg accuracy achieved for 10 subjects)<br>
**Cedric:**<br>
**Arsha:**<br>
